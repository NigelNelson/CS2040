...
Objects0=../build-$(ConfigurationName)/lab6/teleporter.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/lab6/treasure.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/lab6/item.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/lab6/main.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/lab6/room.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/lab6/maze.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/lab6/bag.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/lab6/exit.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/lab6/rogue.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/lab6/collection.cpp$(ObjectSuffix) \
	../build-$(ConfigurationName)/lab6/key.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/lab6/game_controller.cpp$(ObjectSuffix) 
